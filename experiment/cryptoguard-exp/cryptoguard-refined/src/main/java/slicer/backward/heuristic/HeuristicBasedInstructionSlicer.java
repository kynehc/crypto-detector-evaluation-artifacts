...
/**
 * HeuristicBasedInstructionSlicer class.
 *
 * @author franceme
 * @version 03.07.01
 */
public class HeuristicBasedInstructionSlicer extends CustomBackwardFlowAnalysis {
  ...
  /**
   * Constructor for HeuristicBasedInstructionSlicer.
   *
